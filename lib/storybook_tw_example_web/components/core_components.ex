defmodule StorybookTwExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(StorybookTwExampleWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(StorybookTwExampleWeb.Gettext, "errors", msg, opts)
    # end
